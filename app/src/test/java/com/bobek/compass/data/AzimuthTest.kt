...
class AzimuthTest {
    ...
    fun cardinalDirection() {
        ...
        assertEquals(CardinalDirection.NORTH_NORTHEAST, Azimuth(22.5f).cardinalDirection)
        assertEquals(CardinalDirection.NORTHEAST, Azimuth(45f).cardinalDirection)
        assertEquals(CardinalDirection.EAST_NORTHEAST, Azimuth(67.5f).cardinalDirection)
        assertEquals(CardinalDirection.EAST, Azimuth(90f).cardinalDirection)
        assertEquals(CardinalDirection.EAST_SOUTHEAST, Azimuth(112.5f).cardinalDirection)
        assertEquals(CardinalDirection.SOUTHEAST, Azimuth(135f).cardinalDirection)
        assertEquals(CardinalDirection.SOUTH_SOUTHEAST, Azimuth(157.5f).cardinalDirection)
        assertEquals(CardinalDirection.SOUTH, Azimuth(180f).cardinalDirection)
        assertEquals(CardinalDirection.SOUTH_SOUTHWEST, Azimuth(202.5f).cardinalDirection)
        assertEquals(CardinalDirection.SOUTHWEST, Azimuth(225f).cardinalDirection)
        assertEquals(CardinalDirection.WEST_SOUTHWEST, Azimuth(247.5f).cardinalDirection)
        assertEquals(CardinalDirection.WEST, Azimuth(270f).cardinalDirection)
        assertEquals(CardinalDirection.WEST_NORTHWEST, Azimuth(292.5f).cardinalDirection)
        assertEquals(CardinalDirection.NORTHWEST, Azimuth(315f).cardinalDirection)
        assertEquals(CardinalDirection.NORTH_NORTHWEST, Azimuth(337.5f).cardinalDirection)
    }

    @Test
    fun cardinalDirectionJunctions() {
        assertEquals(CardinalDirection.NORTH, Azimuth(348.75f).cardinalDirection)
        assertEquals(CardinalDirection.NORTH_NORTHEAST, Azimuth(11.25f).cardinalDirection)
        assertEquals(CardinalDirection.NORTHEAST, Azimuth(33.75f).cardinalDirection)
        assertEquals(CardinalDirection.EAST_NORTHEAST, Azimuth(56.25f).cardinalDirection)
        assertEquals(CardinalDirection.EAST, Azimuth(78.75f).cardinalDirection)
        assertEquals(CardinalDirection.EAST_SOUTHEAST, Azimuth(101.25f).cardinalDirection)
        assertEquals(CardinalDirection.SOUTHEAST, Azimuth(123.75f).cardinalDirection)
        assertEquals(CardinalDirection.SOUTH_SOUTHEAST, Azimuth(146.25f).cardinalDirection)
        assertEquals(CardinalDirection.SOUTH, Azimuth(168.75f).cardinalDirection)
        assertEquals(CardinalDirection.SOUTH_SOUTHWEST, Azimuth(191.25f).cardinalDirection)
        assertEquals(CardinalDirection.SOUTHWEST, Azimuth(213.75f).cardinalDirection)
        assertEquals(CardinalDirection.WEST_SOUTHWEST, Azimuth(236.25f).cardinalDirection)
        assertEquals(CardinalDirection.WEST, Azimuth(258.75f).cardinalDirection)
        assertEquals(CardinalDirection.WEST_NORTHWEST, Azimuth(281.25f).cardinalDirection)
        assertEquals(CardinalDirection.NORTHWEST, Azimuth(303.75f).cardinalDirection)
        assertEquals(CardinalDirection.NORTH_NORTHWEST, Azimuth(326.25f).cardinalDirection)
    }

    @Test
    fun cardinalDirectionPrecision() {
        assertEquals(CardinalDirection.NORTH, Azimuth(11.2499f).cardinalDirection)
        assertEquals(CardinalDirection.NORTH_NORTHEAST, Azimuth(33.7499f).cardinalDirection)
        assertEquals(CardinalDirection.NORTHEAST, Azimuth(56.2499f).cardinalDirection)
        assertEquals(CardinalDirection.EAST_NORTHEAST, Azimuth(78.7499f).cardinalDirection)
        assertEquals(CardinalDirection.EAST, Azimuth(101.2499f).cardinalDirection)
        assertEquals(CardinalDirection.EAST_SOUTHEAST, Azimuth(123.7499f).cardinalDirection)
        assertEquals(CardinalDirection.SOUTHEAST, Azimuth(146.2499f).cardinalDirection)
        assertEquals(CardinalDirection.SOUTH_SOUTHEAST, Azimuth(168.7499f).cardinalDirection)
        assertEquals(CardinalDirection.SOUTH, Azimuth(191.2499f).cardinalDirection)
        assertEquals(CardinalDirection.SOUTH_SOUTHWEST, Azimuth(213.7499f).cardinalDirection)
        assertEquals(CardinalDirection.SOUTHWEST, Azimuth(236.2499f).cardinalDirection)
        assertEquals(CardinalDirection.WEST_SOUTHWEST, Azimuth(258.7499f).cardinalDirection)
        assertEquals(CardinalDirection.WEST, Azimuth(281.2499f).cardinalDirection)
        assertEquals(CardinalDirection.WEST_NORTHWEST, Azimuth(303.7499f).cardinalDirection)
        assertEquals(CardinalDirection.NORTHWEST, Azimuth(326.2499f).cardinalDirection)
        assertEquals(CardinalDirection.NORTH_NORTHWEST, Azimuth(348.7499f).cardinalDirection)
    }
